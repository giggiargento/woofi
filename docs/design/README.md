...
Design system documentation for the UX/UI agent. Dev agent: read specs here before large visual changes; implement screen logic in `app/` using components from `src/components/ui/`.
